...
class Workout(BaseModel):
    ...
    plans: Optional[List['Plan']] = Field(alias="ids de planos que possuem o treino", default=[])
    exercises: Optional[List['Exercise']] = Field(alias="ids de exercícios do treino", default=[])
